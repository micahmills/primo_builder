...
<style>
	header {
		...
		header .left-container button:hover {
					color: var(--primo-color-brand);
				}

		header .left-container button:focus {
					color: var(--primo-color-brand);
					outline: 0;
				}

		header .left-container button svg {
					width: 1.5rem;
					height: 1.5rem;
				}
		...
		header .center-container .svg :global(svg) {
					--size: 1rem;
					width: var(--size);
					height: var(--size);
				}
		...
		header .right-container .code-mode {
				padding: 0 1rem;
