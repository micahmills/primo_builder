...
<script>
	...
	import { processCode, convert_html_to_markdown } from '../../../utils'
	import { hovering_outside } from '../../../utilities'
	...
	import { get_content_with_static } from '../../../stores/helpers'
