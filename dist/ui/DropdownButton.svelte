...
<style>
	.DropdownButton {
		...
		.DropdownButton .primary-button {
		}
		.DropdownButton.is_open .primary-button .child-button {
					border-bottom-left-radius: 0;
				}
		.DropdownButton.is_open .primary-button button:nth-child(2) {
					border-bottom-right-radius: 0;
				}
		.DropdownButton.is_open .dropdown-content {
				opacity: 1;
			}
		.DropdownButton .primary-button {
			width: 100%;
		...
		.DropdownButton .primary-button button:nth-child(2) {
		...
		.DropdownButton .primary-button button:nth-child(2):hover {
					/* box-shadow: var(--primo-ring-primogreen-thin); */
					color: var(--primo-color-brand);
				}
		.DropdownButton .primary-button:hover {
      ...
      color: var(--PrimaryButton-color-hover, var(--primo-color-white)); */
		...
		.DropdownButton .primary-button[disabled] {
				color: #cecece;
				border: 1px solid #35d994;
				opacity: 0.2;
				cursor: not-allowed;
			}
		.DropdownButton .child-button:first-child {
			border: 1px solid var(--color-gray-7);
			display: flex;
			align-items: center;
			width: 100%;
		...
		.DropdownButton .child-button:first-child:hover {
				position: relative;
				z-index: 1;
				box-shadow: var(--primo-ring-primogreen-thin);
			}
		.DropdownButton .dropdown-content {
			position: absolute;
			top: 100%;
			width: 100%;
		...
		.DropdownButton .dropdown-content .child-button {
				display: flex;
				gap: 0.25rem;
				justify-content: center;
				align-items: center;
